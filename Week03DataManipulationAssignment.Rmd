...
Enter code in the following code blocks to calcuate a final score for the Fear of Statistics Scale for each participant. Call the new variable FOSS_total.
```{r}
